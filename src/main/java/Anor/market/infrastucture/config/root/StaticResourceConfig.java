 ...
 * With this configuration, Spring maps a URL prefix (/static/**) to that folder,
 ...
 * <a href="http://localhost:8080/static/products/12345.png">...</a>
...
public class StaticResourceConfig implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/static/**").addResourceLocations(Path.of(root).toUri().toString());
    }
}
